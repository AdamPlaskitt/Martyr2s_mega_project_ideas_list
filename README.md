...
Working through all the project ideas on [Martyr2’s Mega Project List](http://www.dreamincode.net/forums/topic/78802-martyr2s-mega-project-ideas-list/).

A copy of the list and my progress:

## Numbers
---

### ~~Find PI to the Nth Digit~~cd 
...
> (temp, currency, volume, mass and more)
...
Create a class, or a set of classes, that generates bar charts, pie charts, histograms, and scatter plot charts. For added complexity, make this a service where people can connect to a web server, supply information and it returns a chart image for them in gif or jpg format.
